...
class tabsqlitedb:
    '''Phrase database for indic-tables'''
    def __init__(self, name = 'table.db', user_db = None, filename = None ):
        ...
        if user_db != None:
            ...
            tables_path = path.join (home_path, ".ibus",  "indic-tables")
        ...
        # try create all indic-tables in user database
    ...
    def create_tables (self, database):
        '''Create indic-tables that contain all phrase'''
    ...
    def select_words( self, tabkeys, onechar=False, bitmask=0 ):
        ...
        This method is called in indic_table.py by passing UserInput held data
        Return result[:] 
        '''
